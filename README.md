...
**Миллионы матчей Hearthstone в неделю.** Спроектировал систему парсинга и анализа, которая обрабатывает данные о матчах, сортирует их и формирует нужные аналитические выборки.
...
### ИИ в рабочем процессе

Работаю с **Codex и Claude Code**: настраиваю контекст, инструкции, skills и права доступа под конкретную задачу. Встраиваю ИИ в разработку и работу с контентом.

Отвечаю за результат: проверяю изменения, запускаю тесты, отделяю экспериментальную среду от продакшена. Для рискованных операций задаю ограничения, контрольные проверки и план отката.
